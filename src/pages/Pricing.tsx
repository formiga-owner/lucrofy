        ...
        <div className="min-h-screen bg-background text-foreground py-20 px-4 md:px-8">
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-4xl mx-auto">
                    ...
                    <Card className="border-border/50 shadow-soft hover:shadow-lg transition-all duration-300">
                        <CardHeader className="space-y-2">
                            ...
                            <CardDescription className="text-base pt-2">
                                Para quem quer organizar os produtos e entender o lucro real.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    {/* Pro Plan */}
                    <Card className="relative border-primary shadow-glow md:-mt-8 transform transition-transform duration-300 bg-card">
                        ...
                        <CardHeader className="space-y-2">
                            ...
                            <div className="flex items-baseline gap-1">
                                <span className="text-4xl font-bold">R$ 26</span>
                                <span className="text-muted-foreground">/ mês</span>
                            </div>
                            <CardDescription className="text-base pt-2">
                                Para quem quer tomar decisões com dados e aumentar a margem de lucro.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ul className="space-y-4">
                        ...
                        <CardFooter>
                            <Button className="w-full text-lg h-12 shadow-md hover:shadow-lg transition-all">
                                Quero o plano Pro
                            </Button>
                        </CardFooter>
                    </Card>
